...
2. **Compile and Run**
   ...
   ```bash
   mvn compile exec:java -Dexec.mainClass="com.khabinaki.Main"
   ```

3. **Alternative: Package and Run**
   ```bash
   mvn clean package
   java -jar target/KhabiNaki-1.0-SNAPSHOT.jar
   ```
...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/"
                  xmlns:res="http://service.KhabiNaki.com/">
   <soapenv:Header/>
   <soapenv:Body>
